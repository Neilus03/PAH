...
dataset_config = {
    ...
    'data_dir': "/home/dvidal/TSR/TSR/data"
}
...
# -----------------------
training_config = {
    "epochs_per_timestep": 70,  # Number of epochs per timestep (task).
...
name = f"Hyper-prot{'-'+frozen}{'-'+pretrained}-{model_config['backbone']}-{dataset_config['dataset']}"
logging_config = {
