...
dataset_config = {
    ...
    "BATCH_SIZE": BATCH_SIZE_VAR,  # Batch size used during training.
    ...
    'data_dir': "/ghome/mpilligua/AdvancedProject/TSR/data"
}
...
logging_config = {
    ...
    "group": "Hyper",  # Group name for the experiment.
}
