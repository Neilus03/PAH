...
training_config = {
    ...
    "ewc_lambda": 5000,  # Lambda hyperparameter for EWC. The higher, the more the model will remember the previous task.
...
name = f"EWC baseline-{frozen}-{model_config['backbone']}-{dataset_config['dataset']}"
logging_config = {
