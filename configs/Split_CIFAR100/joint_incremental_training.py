...
name = f"joint incremental training baseline-{frozen}-{model_config['backbone']}-{dataset_config['dataset']}"
logging_config = {
    ...
    "results_dir": "results/joint_incremental_training",  # Folder to save the results.
