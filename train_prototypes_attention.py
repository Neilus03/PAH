...
from networks.hypernetwork import HyperCMTL, HyperCMTL_prototype, HyperCMTL_prototype_attention
        ...
        for e in range(EPOCHS_PER_TIMESTEP):
            ...
            for batch_idx, batch in enumerate(progress_bar):
                ...
                if task_id not in inputs_hyper_x_task:
                    ...
                    # save prototypes using mpl
                    # for i, prototype in enumerate(prototypes):
                    #     plt.imshow(prototype.permute(1, 2, 0).cpu().numpy())
                    #     plt.savefig(f'{results_dir}/task_{t}_prototype_{i}.png')
                    #     plt.close()
